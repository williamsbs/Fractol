...
/*   Updated: 2018/02/08 14:28:11 by wsabates         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_julia1(t_var *var)
{
	...
	var->draw, var->draw.x, var->draw.y, var->draw.tab[var->draw.num]\
	[var->draw.lave] - (var->draw.y * var->draw.x)) : \
	mlx_pixel_put_to_image(var->draw, var->draw.x, var->draw.y, var->draw.tab\
	[var->draw.num][var->draw.lave] - (var->draw.k));
	}
}
