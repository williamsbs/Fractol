...
/*   Updated: 2018/02/06 16:59:23 by wsabates         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/fract.h"

static void	ft_color(t_var *var, int k)
{
...
var->draw.tab[9][var->draw.lave] - (var->draw.y * var->draw.x * k));
}

static void	ft_mega_psy1(t_var *var)
{
	int k;
