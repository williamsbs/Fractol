...
/*   Updated: 2018/02/06 16:58:30 by wsabates         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
(var->draw.y * var->draw.x)) : mlx_pixel_put_to_image(var->draw, var->draw.x,\
var->draw.y, var->draw.tab[9][var->draw.lave] - (var->draw.la));
}

static void	ft_mandelbrot1(t_var *var)
{
