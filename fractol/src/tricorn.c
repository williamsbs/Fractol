...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/01/22 17:02:51 by wsabates          #+#    #+#             */
/*   Updated: 2018/02/06 17:37:27 by wsabates         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_tricorn1(t_var *var)
{
	while (var->draw.y++ < WIN_Y)
	{
		...
		var->draw.z_i = 0;
		var->draw.i = 0;
		while ((var->draw.z_r * var->draw.z_r + var->draw.z_i * var->draw.z_i \
			< var->draw.op) && (var->draw.i < var->draw.iteration_max))
		{
